...
class Post extends Eloquent {
	...
	public function widgets() {
		return $this->belongsToMany('Widget','widgets_refs','item_id','widget_id')->where('type', 'post')->select('widgets_refs.*', 'widgets.name', 'widgets.form', 'widgets_refs.id as wrid')->orderBy('widgets_refs.position', 'asc');
	}
}
