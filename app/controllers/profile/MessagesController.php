...
class MessagesController extends BaseController {
	...
	public function getMessages($cId)
	{
		...
		$messages = ConversationReply::select('users.username', 'users.first_name', 'users.last_name', 'users.avatar', 'conversation_reply.*', 'conversation_reply.*')
	...
	public function postCompose()
	{
		...
		if(is_null($conversation))
		{
			...
			$conversation->save();
			$conversation->c_id = $conversation->id;
		} else {			
			$conversation->save();
		}
		// insert body message
