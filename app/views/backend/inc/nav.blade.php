  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse  {{ ((Request::is('admin/news*') || Request::is('admin/categories*') || Request::is('admin/tags*') || Request::is('admin/comments*') || Request::is('admin/royalties*')) ? ' show' : 'collapse') }}">
      <div class="panel-body">
        ...
        <a href="{{ URL::to('admin/tags') }}" class="{{ (Request::is('admin/tags*') ? ' active' : '') }}"><i class="icon-chevron-right"></i> Luồng sự kiện</a>
        ...
        <a href="{{ URL::to('admin/royalties') }}" class="{{ (Request::is('admin/royalties*') ? ' active' : '') }}"><i class="icon-chevron-right"></i> Nhuận bút</a>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseHb">
          <span class="fa fa-shopping-cart"></span> Gian hàng
        </a>
      </h4>
    </div>
    <div id="collapseHb" class="panel-collapse  {{ (Request::is('admin/cart*') ? ' show' : 'collapse') }}">
      <div class="panel-body">
        ...
        <hr style="margin: 5px 0" />
        <a href="{{ URL::to('admin/cart/orders') }}" class="{{ (Request::is('admin/cart/orders*') ? ' active' : '') }}"><i class="icon-chevron-right"></i> Đơn hàng</a>
        <!-- <a href="{{ URL::to('admin/cart/statistic') }}" class="{{ (Request::is('admin/cart/statistic*') ? ' active' : '') }}"><i class="icon-chevron-right"></i> Thống kê</a> -->
        <a href="{{ URL::to('admin/cart/reviews') }}" class="{{ (Request::is('admin/cart/reviews*') ? ' active' : '') }}"><i class="icon-chevron-right"></i> Bình luận</a>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
