...
@section('content')
	<h3>
    	<span class="glyphicon glyphicon-book"></span> Sửa trang dịch vụ
    </h3>
	<!-- Tabs -->
		...
		<div class="row">
					...
					<div class="tab-pane active" id="tab-general">
						...
						<div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
							...
							<div class="input-group">
							  <span class="input-group-addon">{{ str_finish(URL::to('/'), '/') }}dich-vu/</span>
			...
			<div class="col-md-3">
				...
				@if ( Sentry::getUser()->hasAnyAccess(['pages','pages.delete']) )
					<a onclick="confirmDelete(this); return false;" href="{{ route('delete/service', $post->id) }}" class="btn btn-danger btn-xs">@lang('button.delete')</a>
				@endif
			</div>
		</div>
	</form>
