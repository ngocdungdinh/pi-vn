...
@section('content')
	<h3>
    	<span class="glyphicon glyphicon-th-large"></span> Chuyên mục - Vật liệu xây dựng
    	@if ( Sentry::getUser()->hasAnyAccess(['cart','cart.createcategory']) )
    		<a href="{{ route('createcategory2/cart') }}" class="btn btn-default btn-xs">Tạo chuyên mục</a>
    	@endif
    </h3>
